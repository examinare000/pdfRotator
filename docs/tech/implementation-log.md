...
- 2025-12-22: UIをEditorial/Magazineスタイルに刷新。Cormorant Garamond/DM Sans/JetBrains Monoのフォント構成、シアン系から朱色アクセントへ変更、グロー効果を廃止しボーダーとラインで区切りを表現。
- 2025-12-22: サムネイルレンダーキューをシリアライズし、並列レンダリングによる不安定さを解消。
- 2025-12-22: OCR向き判定を底辺1/8領域のページ番号認識精度ベースに変更。
- 2025-12-22: OCR結果の尤度返却と固定しきい値(0.6)での回転判定に変更。
- 2025-12-22: OCRタイムアウトのデフォルトを15秒に延長。
